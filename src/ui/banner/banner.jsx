...
export const Banner = () => {
  return (
    <div className='flex gap-10 my-40 mx-30'>
      ...
      <span className='absolute inset-0 flex items-center justify-center font-semibold text-2xl'>In-Progress</span> <span className='absolute inset-0 flex items-center justify-center mt-10 font-semibold text-6xl'><br  />0</span>
      </div>
      <div className='relative'>
